...
* Built-in Support for Siena ORM and JPA
* Built-in user model can be deactivated and own user model with any ORM you like can be used
...
** §more on recaptcha keys":http://www.wikipedia.orghttp://www.playframework.org/modules/recaptcha-1.2/home
...
Basic routes provided for end user:
...
Siena is the default option and is configured out of the box.

h3. Using JPA

Simply set the following two parameters in application.conf:
...
Most likely you'll find Casino!'s views nasty and not fitting your nicely crafted ui design. We know that :) And in
fact you can and should implement your own views and email message templates. Simply copy the directory
